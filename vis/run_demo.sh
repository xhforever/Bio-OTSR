...
PYTHONPATH=. python vis/run_demo.py \
              ...
              misc.output_folder='demo_output/2gpu-freeze-encoder-5-last_step' \
              trainer.ckpt_path='/data/yangxianghao/SKEL-CF/data_outputs/exp/2gpu-freeze-encoder-5/checkpoints/last_step.pth'
